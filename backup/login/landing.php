<?php
include('session.php'); // The all important sesh info 
?>
<!doctype html>
<html lang="en">
                                ...
                                <div class="card-content">
                                    ...
                                    <div class="table-responsive">
                                        ...
                                        <tbody>
                                            ...
                                            $result = mysqli_query($con,"SELECT * FROM  Facility left join FacilityType on Facility.FacilityTypeID = FacilityType.FacilityTypeID");
                                            ...
                                            {
                                            echo "<tr>";
                                            echo '<td><a href="/testresults.php?id='. $row['FacilityID'].'">'.$row['FacilityName'].'</a></td>';
                                            echo "<td>" . $row['City'] . "</td>";
